...
class HistoryListTile extends StatelessWidget {
  const HistoryListTile({super.key, required this.id, required this.formule, required this.result});
  ...
  Widget build(BuildContext context) {
    ...
    return DecoratedBox(
      ...
      child: ListTile(
        title: Text(result.toString(), style: theme.textTheme.titleMedium?.copyWith(fontSize: 19.0),),
        subtitle: Text(formule),
        trailing: Row(
